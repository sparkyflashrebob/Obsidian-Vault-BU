...
The four exertions (_cattārimāni padhānāni_) are summarized as:

1.  **Restraint** (__saṃvara padhāna__) of the [senses](https://en.wikipedia.org/wiki/Ayatana "Ayatana").
2.  **Abandonment** (__pahāna padhāna__) of [defilements](https://en.wikipedia.org/wiki/Kilesa "Kilesa").
3.  **Cultivation** (__bhāvanā padhāna__) of [Enlightenment Factors](https://en.wikipedia.org/wiki/Bojjhanga "Bojjhanga").
4.  **Preservation** (__anurakkhaṇā padhāna__) of [concentration](https://en.wikipedia.org/wiki/Sam%C4%81dhi_(Buddhism) "Samādhi (Buddhism)"), for instance, using charnel-ground contemplations.[[15]](https://en.wikipedia.org/wiki/Four_Right_Exertions#cite_note-15)