...
-5 functions or aspects that constitute the sentient being
-nothing among them is really "I" or "mine"
- suffering arises when one identifies or clings to the aggregate
- suffering is extinguished by relinquishing attachments to aggregates
- No essence - example of the chariot - just a concept.  conventionally chariots exist.
...
A.  In the Nikayas/Āgamas: cognizance,[3][m] that which discerns[4][n]
B. In the Ahidhamma: a series of rapidly changing interconnected discrete acts of cognizance.[o]
C. In some Mahayana sources: the base that supports all experience.[p]



 

![[1433724139635.38454116.png]]