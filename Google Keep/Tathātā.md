...
Theravada Buddhism
In Theravada, this term designates the nature of existence (bhāva), the truth which applies to things. According to the Kathavatthu, tathātā is not an unconditioned or un-constructed (asankhata) phenomenon.[5] The only phenomena which is un-constructed in Theravada is Nibbana.[6]
