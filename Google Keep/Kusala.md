...
It is defined in M.9 as the 10 wholesome courses of action (s. kammapatha). 
In psychological terms, 'karmically wholesome' are all those karmical volitions (kamma-cetanā) and the consciousness and mental factors associated therewith, which are accompanied by 2 or 3 wholesome roots (s. mūla), i.e. by greedlessness (alobha) and hatelessness (adosa), and in some cases also by non-delusion (amoha: wisdom, understanding). 

Such states of consciousness are regarded as 'karmically wholesome' as they are causes of favourable karma results and contain the seeds of a happy destiny or rebirth. 
