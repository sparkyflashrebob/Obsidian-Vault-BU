...
Step 5- 8 Feeling
Steps 9 - 12 Mind
Steps 13 - 16 Mind-Objects
# Notes

[1](https://www.accesstoinsight.org/tipitaka/mn/mn.118.than.html#fnt-1).
...
[2](https://www.accesstoinsight.org/tipitaka/mn/mn.118.than.html#fnt-2).
The commentaries insist that "body" here means the breath, but this is unlikely in this context, for the next step — without further explanation — refers to the breath as "bodily fabrication." If the Buddha were using two different terms to refer to the breath in such close proximity, he would have been careful to signal that he was redefining his terms (as he does below, when explaining that the first four steps in breath meditation correspond to the practice of focusing on the body in and of itself as a frame of reference). The step of breathing in and out sensitive to the entire body relates to the many similes in the suttas depicting jhana as a state of whole-body awareness (see [MN 119](https://www.accesstoinsight.org/tipitaka/mn/mn.119.than.html)).
[3](https://www.accesstoinsight.org/tipitaka/mn/mn.118.than.html#fnt-3).
"In-&-out breaths are bodily; these are things tied up with the body. That's why in-&-out breaths are bodily fabrications." — [MN 44](https://www.accesstoinsight.org/tipitaka/mn/mn.044.than.html).
[4](https://www.accesstoinsight.org/tipitaka/mn/mn.118.than.html#fnt-4).
"Perceptions & feelings are mental; these are things tied up with the mind. That's why perceptions & feelings are mental fabrications." — [MN 44](https://www.accesstoinsight.org/tipitaka/mn/mn.044.than.html).
[5](https://www.accesstoinsight.org/tipitaka/mn/mn.118.than.html#fnt-5).
[AN 9.34](https://www.accesstoinsight.org/tipitaka/an/an09/an09.034.than.html) shows how the mind, step by step, is temporarily released from burdensome mental states of greater and greater refinement as it advances through the stages of jhana.
[6](https://www.accesstoinsight.org/tipitaka/mn/mn.118.than.html#fnt-6).
