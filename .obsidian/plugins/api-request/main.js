...
var require_decode_codepoint = __commonJS({
  "node_modules/entities/dist/commonjs/decode-codepoint.js"(exports) {
    "use strict";
    var _a;
...
var require_decode_shared = __commonJS({
  "node_modules/entities/dist/commonjs/internal/decode-shared.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_decode_data_html = __commonJS({
  "node_modules/entities/dist/commonjs/generated/decode-data-html.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_decode_data_xml = __commonJS({
  "node_modules/entities/dist/commonjs/generated/decode-data-xml.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_bin_trie_flags = __commonJS({
  "node_modules/entities/dist/commonjs/internal/bin-trie-flags.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_decode = __commonJS({
  "node_modules/entities/dist/commonjs/decode.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_Tokenizer = __commonJS({
  "node_modules/htmlparser2/dist/commonjs/Tokenizer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_Parser = __commonJS({
  "node_modules/htmlparser2/dist/commonjs/Parser.js"(exports) {
    "use strict";
...
var require_commonjs = __commonJS({
  "node_modules/htmlparser2/dist/commonjs/index.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
var APRSettings = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian2.Setting(containerEl).setName("Codeblocks").setHeading();
    ...
    new import_obsidian2.Setting(containerEl).setName("Enable interactive status bar").setDesc("Show clickable status bar with request counter and navigation").addToggle(
    ...
    new import_obsidian2.Setting(containerEl).setName("Active request color").setDesc("Color for active requests (not disabled or with auto-update)").addText(
      (text) => text.setPlaceholder("#4ade80").setValue(this.plugin.settings.statusBarActiveColor).onChange(async (value) => {
        this.plugin.settings.statusBarActiveColor = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian2.Setting(containerEl).setName("Inactive request color").setDesc("Color for disabled requests").addText(
      (text) => text.setPlaceholder("#9ca3af").setValue(this.plugin.settings.statusBarInactiveColor).onChange(async (value) => {
        this.plugin.settings.statusBarInactiveColor = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian2.Setting(containerEl).setName("Global variables").setHeading();
    ...
    new import_obsidian2.Setting(containerEl).setName("Manage global variables").setHeading();
    this.displayKeyValues();
    new import_obsidian2.Setting(containerEl).setName("Saved API requests").setHeading();
...
function formatOutput(output) {
  ...
  if (typeof output === "object" && output !== null) {
    return (_a = JSON.stringify(output, null, 2)) != null ? _a : "";
  }
  return unknownToString(output);
}
function checkVariables(req_prop, settings, app) {
  try {
    ...
    if (match) {
      for (let i = 0; i < match.length; i++) {
        ...
        try {
          ...
          new import_obsidian3.Notice("Error reading frontmatter: " + getErrorMessage(e));
          return void 0;
        }
      }
    }
    ...
    new import_obsidian3.Notice("Error processing variables: " + getErrorMessage(e));
    return void 0;
  }
}
var MainAPIR = class extends import_obsidian3.Plugin {
  ...
  async onload() {
    ...
    const debouncedUpdate = (0, import_obsidian3.debounce)(() => this.updateStatusBar(), 300);
    this.registerEvent(
        ...
        async (source, el) => {
          ...
          for (const line of sourceLines) {
            ...
            if (lowercaseLine.startsWith("#") || lowercaseLine.startsWith("//")) {
              ...
              const tempBody = (_e = checkVariables(
                line.replace("body:", "").trim(),
                this.settings,
                this.app
              )) != null ? _e : "";
              try {
                body = (_f = parseToValidJson(tempBody, "body")) != null ? _f : void 0;
              } catch (e) {
              ...
              const resolvedUuid = (_g = checkVariables(
                uuid,
                this.settings,
                this.app
              )) != null ? _g : "";
            ...
            try {
              ...
              if (uuid) {
                try {
                  ...
                  new import_obsidian3.Notice("Warning: Failed to cache response");
                }
              }
            } catch (e) {
              console.error(getErrorMessage(e));
              new import_obsidian3.Notice("Error: " + getErrorMessage(e));
          ...
          if (show) {
            ...
            if (paths.length > 1) {
              output = paths.map((path) => {
                try {
                  return String(JSONPath({ path: path.trim(), json: responseData }));
                } catch (e) {
              ...
              try {
                output = String(JSONPath({ path: paths[0], json: responseData }));
              } catch (e) {
            ...
            if (properties.length > 0 && properties[0] !== "") {
              ...
              if (properties.length === 1) {
                const propertyName = (_h = properties[0]) == null ? void 0 : _h.trim();
                if (!propertyName) return;
                await updateFrontmatter(propertyName, stringOutput);
              } else {
                for (let index2 = 0; index2 < properties.length; index2++) {
                  const propertyName = (_i = properties[index2]) == null ? void 0 : _i.trim();
            ...
            try {
              ...
              try {
                ...
                if (file instanceof import_obsidian3.TFile) {
                  ...
                  new import_obsidian3.Notice("Error: Could not save to file");
                  console.error("File save error:", e);
                }
              } catch (modifyError) {
                new import_obsidian3.Notice("Error: Failed to save file");
  ...
  parseReqBlocks() {
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (trimmedLine.startsWith("```req")) {
        ...
        currentBlock.isActive = currentBlock.uuid !== null && currentBlock.autoUpdate || !currentBlock.disabled && currentBlock.uuid === null;
        ...
        if (lowercaseLine.startsWith("req-uuid:")) {
          ...
          uuid = (_a = checkVariables(uuid, this.settings, this.app)) != null ? _a : "";
  ...
  showRequestMenu(event) {
    ...
    if (this.reqBlocks.length === 0) {
      ...
      this.reqBlocks.forEach((block) => {
        menu.addItem((item) => {
          item.setTitle(`${block.displayName}${block.isActive ? " \u{1F7E2}" : " \u26AA"}`);
          item.setIcon("rocket");
          item.onClick(() => {
