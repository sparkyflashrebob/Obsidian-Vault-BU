...
# Property dispute and financial stress, ETF dividend and AI discussion, and ETF Investment Education Webinar
...
- **Core Topics**: #environmental-news, #fixed-income-strategy, #team-leadership
- **Entities & Terms**: #distributed-model, #fidelity-investments, #spokane-wildfires
- **Key Actions**: #environmental-monitoring, #financial-inquiry, #organizational-strategy
- **Keywords**: #bee-reports, #bonds, #daily-notes, #leadership, #logging, #obsidian, #wildfires, #workflow

---

## 📅 Google Calendar Events Today
- **Understanding ETFs: Market Outlook** (10:00 AM)
- **Understanding ETFs: Navigating Market Volatility** (11:00 AM)
- **Understanding ETFs: Navigating Common Financial Goals** (12:00 PM)
- **OAKLAND – TRUST THE UNIVERSE: The Philosophy of Alan Watts / 360˙ DOME** (7:00 PM)
- **OAKLAND – TRUST THE UNIVERSE: The Philosophy of Alan Watts / 360˙ DOME** (7:00 PM)
...
- **To**: `Mindy Wyman <mindy@wymanpm.com>` | **Subject**: Re: 138 Underhill Drive (10:08 AM)
  *Summary*: "Mindy, I understand your position. As I mentioned, I did not sign on as a co-signer for both James and Ryan in the first place but only helped the last time because it involved my..."

- **To**: `The Grove Lux Apts <thegroveluxapts@emailrelay.com>` | **Subject**: Re: The Grove Lux Apts: Thank you for touring with me! (9:59 AM)
  *Summary*: "Maya, We have decided to hold on this for a few months. We can revisit later. Will I be able to get my security deposit back? On Thu, Jun 25, 2026 at 9:58 AM The Grove Lux Apts &lt..."

- **To**: `Ryan McGuire <bzmcguire@gmail.com>` | **Subject**: Re: 138 Underhill Drive (9:33 AM)
  *Summary*: "Hello Mindy, Today I got a call from Omar, I believe, saying that there was more rent due on this location. We had talked about this previously. Ryan moved out at the end of last m..."
...
### 1. Property dispute and financial stress (8:59 AM – 10:45 AM)
...
### 2. ETF dividend and AI discussion — 📍 Understanding ETFs: Market Outlook (10:45 AM – 10:56 AM)
*Context / Event Alignment*: Overlaps with scheduled Calendar event **Understanding ETFs: Market Outlook**.

Andy had a Fidelity investment webinar playing in his environment on June 25, 2026, titled "Understanding ETFs: Market Outlook." The session covered ETF dividend mechanics and AI infrastructure investing, with a guest named Christy explaining how ETFs aggregate and distribute quarterly or semi-annual dividends to holders. The webinar was scheduled as part of a three-session series, with follow-up sessions at 2:00 PM and 3:00 PM Eastern Time. The content included information about Fidelity.com platform features for investors.


### 3. ETF Investment Education Webinar — 📍 Understanding ETFs: Market Outlook (11:00 AM – 11:54 AM)
*Context / Event Alignment*: Overlaps with scheduled Calendar event **Understanding ETFs: Market Outlook**.
...
### 1. ETF Investment Strategies Webinar — 📍 Understanding ETFs: Navigating Market Volatility (12:00 PM – 1:02 PM)
...
### 2. Planning concerts and calendar events (2:31 PM – 3:12 PM)
Andy and his partner Andrea spent time coordinating their upcoming calendar, focusing on concerts and practical household matters. Andy shared his views on semi-truck driving as a declining career due to automation and immigration policy changes. They discussed attending Sly Stone (July 1st) and Steel Pulse (July 2nd) concerts at the Marin County Fair, with Andy noting his color-coding system for calendar events (avoiding default green, using salmon/rust for Buddhist events, red for urgent items, yellow for other priorities). They also checked tide alerts for their flood-prone area, with Andy mentioning his automated script for monthly tide updates and his alert threshold of 6.5 feet. Andy was recovering from some health issue and hoping to feel better for a planned storage unit trip. They also discussed a JSJ Distance Healing Seminar on Saturday that would conflict with timing for other activities.


### 3. Conflict resolution masterclass discussion (4:11 PM – 4:44 PM)
Andy spent time at home dealing with ongoing king tide flooding in his Marin County area, coordinating with Andrea and another household member about car relocation and tide timing. They discussed flood delays, street conditions, and the fact that there had been four flood events that day. Andy remained notably calm during the situation, which surprised him given how anxious he felt beforehand.

The majority of the captured audio was Andy consuming a MasterClass course on conflict resolution, which he recorded and took notes on for later translation. He found the content valuable—particularly the framework on listening skills (mirror back what you hear, give opportunity for feedback) and identifying four conflict personality types: avoiders, fighters/"conflict entrepreneurs," and others. He recognized himself and people he knows (mentioning Diana and Shelly) in the material. He got the MasterClass subscription at a discounted rate of $5/month and is exploring other courses including ones by Alicia Keys and on KI (possibly AI or a specific instructor).
...
### 4. Discussing politics immigration and economy (4:53 PM – 5:06 PM)
...
### 1. Fire aftermath with GPS navigation (5:11 PM – 6:03 PM)
...
### 2. Theme park ride safety briefing (6:35 PM – 6:45 PM)
...
### 3. California earthquake fault discovery discussion (8:32 PM – 9:01 PM)
Andy had a casual conversation with a household member while consuming various media content. The interaction covered multiple topics including street activities in Oakland (referred to as "sideshow" behaviors like donuts and dragging), casual discussion about measurements and water intake, and Andy's reactions to entertainment and news programming in the background. Andy showed particular interest in geological news about earthquake fault lines in California, asking clarifying questions about specific locations mentioned in a news segment.


### 4. Sports Results and Trump's Scouting (9:03 PM – 9:12 PM)
Andy was engaging in conversation about World Cup soccer match results, discussing the United States' loss to Turkey (3-2) while noting they had already advanced to the round of sixteen. He was tracking multiple match outcomes including Ecuador beating Germany, Ivory Coast winning, Sweden-Japan tying, and Netherlands defeating Tunisia. Andy mentioned upcoming matches, specifically the US playing Bosnia on July 1st and Brazil facing Japan. The conversation later transitioned to Andy sharing news content about Trump, referencing crowd reactions and expressing the sentiment that people are "tired of hearing his crap."



## 🗣️ Personal Monologues & Direct Thoughts
#### Conflict resolution masterclass discussion (4:11 PM – 4:44 PM)
**Journal Entry**  
...
> "People have a lot of um so learning how to listen involves uh basically um three-step story music and you listen, then you repeat, then you repeat back so if you are mirror it back and then it gives an opportunity to um to uh you know give feedback and that a lot of Conflicts for people have because they don't feel heard. So that's something I think is probably be very good for me to practice, although sometimes it will be like, I am hearing you, but I'm but I may not acknowledge that heard you."

---

## 🧘 Spiritual and Societal Insights
- **The webinar covered**: diversification across asset classes, minimum volatility strategies, buffer ETFs, dollar-cost averaging, and portfolio rebalancing through Fidelity's platform
- **Conflict resolution course**: ** Completed hour-long MasterClass on listening skills and conflict types; key technique is "story, music, listen, repeat back" to ensure people feel heard
...
---
*Report automatically generated on 2026-08-21 06:19:11*