...
# Hospital pickup and ultrasound appointment, Apartment hunting with fireplace concerns, and Apartment hunting with Maya
...
- **Core Topics**: #environmental-news, #fixed-income-strategy, #household-logistics, #recovery-program
- **Entities & Terms**: #12-step-framework, #ambient-sensors, #fidelity-investments, #spokane-wildfires
- **Key Actions**: #environmental-monitoring, #financial-inquiry, #home-monitoring, #personal-development
- **Keywords**: #bee-reports, #bonds, #daily-notes, #logging, #obsidian, #recovery, #temperature, #wildfires, #workflow

---

## 📅 Google Calendar Events Today
- **Fast before Ultrasound** (6:30 AM)
- **travel to hospital** (8:30 AM)
- **Kaiser Radiology Bld 1 1st Flr  Parking Lot D** (9:00 AM)
- **Appointment for Andy** (9:00 AM)
- **Pick up Andrea for Ramona** (2:30 PM)
- **Travel to Ramona** (3:30 PM)
- **House Tour 1340 Ramona Ln, Petaluma, CA 94954** (4:30 PM)
...
- **To**: `Andrea Axtell <dragonflylodge.aa@gmail.com>` | **Subject**: Petaluma House (8:34 PM)
  *Summary*: "https://www.zillow.com/homedetails/Petaluma-CA-94952/15754250_zpid/?utm_campaign=zillowwebmessage&amp;utm_medium=referral&amp;utm_source=txtshare -- Andy McGuire (he/him) (415)637-..."

- **To**: `Andrea Axtell <dragonflylodge.aa@gmail.com>` | **Subject**: https://www.zillow.com/homedetails/Penngrove-CA-94951/15792790_zpid/?utm_campaign=zillowwebmessage&utm_medium=referral&utm_source=txtshare (7:58 PM)
  *Summary*: "-- Andy McGuire (he/him) (415)637-0348 (cell) sparkyflashrebob@gmail.com..."
...
#### Hospital pickup and ultrasound appointment (8:52 AM – 9:33 AM)
* **Meeting Synopsis**: Andy had a medical appointment at Kaiser San Rafael for an abdominal aorta ultrasound. While at the hospital, he was simultaneously coordinating pickup logistics by phone with someone who was having trouble navigating the hospital parking lots and building connections. The ultrasound technician noted Andy was "very gaspy" and still constipated despite treatment, which aligned with what the GI team had previously told him. The procedure required breath-holding and relaxation techniques to get clear images.
* **Key Points by Participant**:
  * **Andy**: Shared on "Yeah, so what he was saying was there's a parking lot on the other side of the hospital."

#### Apartment hunting and space planning (6:40 PM – 7:23 PM)
* **Meeting Synopsis**: Andy and Andrea spent time together researching and evaluating apartment options, focusing on a $2,400/month unit with 12x12 bedrooms and a spacious 24x13 living/dining area. Andy used a room layout tool to plan furniture placement, discussing bed orientation for better feng shui, speaker and shrine placement, desk arrangements, and closet storage solutions. They identified preferred unit numbers (712, 733, 817) based on location and parking, while ruling out others near a corporate yard or fire wall. During the session, a recovery prayer audio played in the background featuring Andrea's voice, which Andy reacted to by saying he needed to record it. Andrea also offered to give Andy a Jin Shin Jyutsu treatment within the next couple hours.
* **Key Points by Participant**:
  * **Andrea** (Wife): Shared on "would you let me give you a treatment later on, within a couple hours?"
  * **Andy**: Shared on "Sure, I hope I can get my mind into that there."

#### Decluttering books before moving (7:24 PM – 7:42 PM)
* **Meeting Synopsis**: Andy and Andrea were sorting through books while preparing for a move, deciding what to keep, give away, or donate. Andy was simultaneously filling out a rental application (mentioning "712" as a unit or property number). They went through various books including a college book, a "thought of the day" book, "Headhunters," and Kate Levinson's "A Woman's Guide to Building Wealth and Shifting Money." Andrea teased Andy about moving and being an "old girl." There was a brief Google Home interaction where someone tried to locate a phone. Andrea expressed concern about Andy hurting his back during the moving process. Andy mentioned he'd already put a bag of shoes outside to donate and was working on clearing things out before the move.
* **Key Points by Participant**:
  * **Andy**: Shared on "Okay, I'm moving three."
  * **Andrea** (Wife): Shared on "I think sorry, yeah, I knew that was go."
...
Andy had a medical appointment at Kaiser San Rafael for an abdominal aorta ultrasound. While at the hospital, he was simultaneously coordinating pickup logistics by phone with someone who was having trouble navigating the hospital parking lots and building connections. The ultrasound technician noted Andy was "very gaspy" and still constipated despite treatment, which aligned with what the GI team had previously told him. The procedure required breath-holding and relaxation techniques to get clear images.

#### Apartment hunting with fireplace concerns (10:26 AM – 10:49 AM)
Andy called a property management company to follow up on a rental viewing he and his wife Andrea had done a couple days prior. He was asking for Maya but spoke with another leasing agent about available units. The main issue was that the townhouse they liked had a fireplace taking up an entire wall, which would prevent them from fitting their furniture (specifically a stereo setup requiring 10.9 feet of wall space and a couch). Andy expressed flexibility on move-in timing, noting September was impossible for them and they were hoping for early-to-mid August, but they'd be willing to wait for a unit without a fireplace. The agent identified unit 233 at a different address, available August 10th, without a fireplace, located in a cul-de-sac/corner location. Andy needed to sort out rent proration questions with his current landlord since a mid-month move would shift his rent due date. The agent agreed to send details via email for Andy to review spatial dimensions before applying.
...
#### AutoCAD Trace Feature Overview (12:46 PM – 12:53 PM)
This was not an active conversation involving Andy. The transcript captures background media content—specifically an AutoCAD tutorial video or software demo playing in his environment. The content covers AutoCAD's trace collaboration feature, which allows multiple users to add feedback to drawings via a virtual tracing paper layer without modifying the original file. The tutorial explains how traces work across AutoCAD mobile and desktop, how to toggle between trace edit and drawing modes, and how to exit traces when finished.

#### Giants Pride Night Bible Verse Controversy (1:09 PM – 1:20 PM)
Andy was having a casual phone or in-person conversation with his father, touching on fantasy football draft strategy and car maintenance. His dad was checking in on him, and they discussed how Andy's previous car died around the same age his current car is now. Andy was mildly resistant to discussing his car's upkeep, suggesting some familiar tension around the topic. A news broadcast about the SF Giants Pride Night Bible verse controversy was playing in the background.

#### House hunting and flood concerns — 📍 Travel to Ramona (3:21 PM – 3:32 PM)
*Context / Event Alignment*: Overlaps with scheduled Calendar event **Travel to Ramona**.

Andy and Andrea discussed logistics for an upcoming move to a new rental property, focusing on space constraints in the living room, flood risk concerns due to an expected strong El Niño year, and their ongoing house-hunting strategy. They considered whether to pursue a specific three-bedroom house despite potential competition, and discussed contingency plans if flooding affects their target areas near Gate 5 and the letters area. Andy referenced a recent article about higher-than-expected flood levels (2-3 feet above projections). They also discussed possibly letting go of "the grove" as a location priority and the need to consolidate belongings for a tighter living space.

#### Apartment hunting and property tours — 📍 Travel to Ramona (4:04 PM – 4:48 PM)
*Context / Event Alignment*: Overlaps with scheduled Calendar event **Travel to Ramona**.

Andy toured a rental property at 1340 Ramona Lane in Petaluma with a real estate agent, then visited the agent's office to discuss application logistics. He later had a phone or video call with Andrea comparing three different rental options, discussing fireplaces, air conditioning types, thermostat controls, and location trade-offs. During driving segments, a podcast or radio played in the background covering topics including a walking group and Warsaw. Andy also noticed a brief car issue where the engine turned off right after starting.

---

### 🌙 Evening Session (5:01 PM – 11:00 PM)
#### Apartment Hunting with Partner — 📍 House Tour 1340 Ramona Ln, Petaluma, CA 94954 @ 1340 Ramona Ln, Petaluma, CA 94954, USA (4:55 PM – 5:11 PM)
*Context / Event Alignment*: Overlaps with scheduled Calendar event **House Tour 1340 Ramona Ln, Petaluma, CA 94954** @ 1340 Ramona Ln, Petaluma, CA 94954, USA.
...
#### Apartment hunting and space planning (6:40 PM – 7:23 PM)
Andy and Andrea spent time together researching and evaluating apartment options, focusing on a $2,400/month unit with 12x12 bedrooms and a spacious 24x13 living/dining area. Andy used a room layout tool to plan furniture placement, discussing bed orientation for better feng shui, speaker and shrine placement, desk arrangements, and closet storage solutions. They identified preferred unit numbers (712, 733, 817) based on location and parking, while ruling out others near a corporate yard or fire wall. During the session, a recovery prayer audio played in the background featuring Andrea's voice, which Andy reacted to by saying he needed to record it. Andrea also offered to give Andy a Jin Shin Jyutsu treatment within the next couple hours.

#### Decluttering books before moving (7:24 PM – 7:42 PM)
Andy and Andrea were sorting through books while preparing for a move, deciding what to keep, give away, or donate. Andy was simultaneously filling out a rental application (mentioning "712" as a unit or property number). They went through various books including a college book, a "thought of the day" book, "Headhunters," and Kate Levinson's "A Woman's Guide to Building Wealth and Shifting Money." Andrea teased Andy about moving and being an "old girl." There was a brief Google Home interaction where someone tried to locate a phone. Andrea expressed concern about Andy hurting his back during the moving process. Andy mentioned he'd already put a bag of shoes outside to donate and was working on clearing things out before the move.

#### Finding car registration documents (7:46 PM – 7:58 PM)
Andy and a household partner (likely Andrea) were organizing vehicle paperwork for their Toyota Corolla Cross, specifically locating the license plate number, registration, and insurance documents. Andy initially thought he had filed the Toyota paperwork alongside his own vehicle documents but realized he may not handle the Toyota's registration. After some searching, they located the information in a file labeled "keep" — the plate is a "silver tag." The conversation ended with Andy musing about which items are worth storing long-term versus discarding.

#### Moving finances and new bed (9:08 PM – 9:18 PM)
Andy and a household member (likely Andrea) discussed practical matters around moving in together, including adjustable beds for snoring relief, the financial burden of security deposits and application fees, and coordinating documentation for rental applications. Andy submitted his Fidelity investment information as income verification and disclosed a prior eviction on his application. They're waiting to hear back from landlords, with Andy suggesting not to worry until Thursday. They also discussed household logistics like new sheets and laundry.

---

## 🗣️ Personal Monologues & Direct Thoughts
#### Apartment hunting and property tours (4:04 PM – 4:48 PM)
**Journal Entry**  
...
> "Yeah, they're all the fire all I got in the only replaces without the fire s that's what I'm No, no, no, I shined my eyes, so I wouldn't know we don't need all three of them, I'm just saying we could pick one. I'll show you there's different slightly different options with the three different sizes, like it's three different sizes, and it depends on location is one of them, and then the other one is another thing that's amenities, meaning one of them has dual, they have dual air conditioning, so it's more air conditioning. So and it has a new newer kind of thermostat control upstairs. Which I like that, but, you know, maybe even the web app, you know me, I'm okay with all of that."

---

## 🧘 Spiritual and Societal Insights
- **Health tracking**: ** Continued monitoring of thyroid/digestive symptoms, with GI team's earlier assessment confirmed by imaging technician's observations
