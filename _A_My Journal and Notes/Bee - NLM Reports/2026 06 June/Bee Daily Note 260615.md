...
# Family conflict and health concerns, Discussing judgment and wisdom, and House Hunting in Sonoma
...
- **Core Topics**: #recovery-program
- **Entities & Terms**: #12-step-framework
- **Key Actions**: #personal-development
- **Keywords**: #bee-reports, #daily-notes, #logging, #obsidian, #recovery, #workflow
...
- **To**: `Andrea Axtell <dragonflylodge.aa@gmail.com>` | **Subject**: Re: SSI Notice (12:29 AM)
  *Summary*: "This will be a one time thing I will get on June 30th and then I will get $3027 $3027 on 7/15 and then $3027 on 3rd Wednesday of each month. On Mon, Jun 15, 2026 at 12:23 AM Andy M..."

- **To**: `Andrea Axtell <dragonflylodge.aa@gmail.com>` | **Subject**: SSI Notice (12:23 AM)
  *Summary*: "-- Andy McGuire (he/him) (415)637-0348 (cell) sparkyflashrebob@gmail.com..."

- **To**: `Andrea Axtell <dragonflylodge.aa@gmail.com>` | **Subject**: Small House (11:58 PM)
  *Summary*: "https://sfbay.craigslist.org/nby/apa/d/el-verano-bed-bath-cottage-walking/7940846630.html -- Andy McGuire (he/him) (415)637-0348 (cell) sparkyflashrebob@gmail.com..."
...
#### Discussing judgment and wisdom — 📍 Blood Work @ San Rafael Avenue, San Rafael Ave, San Rafael, CA 94901, USA (11:26 AM – 11:58 AM)
*Context / Event Alignment*: Overlaps with scheduled Calendar event **Blood Work** @ San Rafael Avenue, San Rafael Ave, San Rafael, CA 94901, USA.
...
#### Medical experience and casual chat (4:10 PM – 4:25 PM)
Andy went downtown for what appears to be a blood draw, where he strategically prepared by staying hydrated to make his veins more accessible—an experiment that seemed to work well with the phlebotomist, an Asian woman who had better success than previous technicians. He and a companion discussed cucumber mint drinks afterward. Later, Andy reacted to a news broadcast about a B-52 bomber crash at Edwards Air Force Base with fatalities, commenting on the severity of the destruction.
...
#### World Cup and Wellness Chat (5:40 PM – 7:52 PM)
Andy spent time watching World Cup soccer highlights with Andrea and possibly another person, actively commenting on matches including Spain's 0-0 draw, Belgium vs. Egypt, and Saudi Arabia's performance. They also watched a tornado video together, with Andy noting details about wind patterns and the tornado struggling to get over a wall. Andy showed someone a music group he's getting into called Inte:rloop, describing it as "the next group I'm getting into" and noting their live performance style. He also briefly sampled content about Native American cultural practices but deferred deeper viewing. The bulk of the recording captures an extended video call with a sponsee/mentee where they troubleshot audio issues (switching from Zoom to Google Meet web version, adjusting noise suppression settings), discussed John Sarno's work on mind-body pain, trauma and nervous system regulation, and explored meditation practices around clinging and the "two arrows" teaching. Andy shared he's been meditating on clinging itself rather than the pain, and discussed his podcast ideas about internal vs. external locus of control. They also talked about king tide flooding affecting his street, requiring car relocations, and his recent return from Joshua Tree with sunburned lips. The call ended with calendar coordination for upcoming meetings and mention of a "Bearing Witness: Stories from the Palestinians" event. Finally, brief exchange with Andrea about her self-help routine for muscle spasms in her right foot.

#### Thyroid results and deer encounter (8:46 PM – 9:01 PM)
Andy was having a health conversation with someone at home about his thyroid condition. His thyroid reading was "off the charts" with an underactive result, requiring him to increase his medication and possibly adjust his supplement timing. The conversation was interspersed with the other person multitasking on computer work and getting dressed. Andy then shared a meaningful moment from the previous evening when he encountered a deer during a walk, describing how he spoke to it gently and it relaxed before slowly walking away.

#### Jin Shin Thyroid Healing Session (9:19 PM – 9:38 PM)
Andy participated in a hands-on Jin Shin Jyutsu learning session with Andrea and at least one other person, focused specifically on energy flows for thyroid support. Andy used Gemini to research the "main central vertical universal harmonizing energy flow" and third depth finger holds for thyroid and endocrine health. The group practiced physical hand placements (top of head and throat), discussed proper technique, and shared reference materials. Andy demonstrated how to use Google Drive's scan-to-PDF feature to digitize charts, and the group saved files for future reference. The session blended practical instruction with collaborative tech problem-solving.
...
> "Like, somebody's got some angst inside of them, right? They've got some angst, and guess what? The trigger is in them. When no, it's not the cause, it's because it's in you, and you're basically receptive to it. I think last week we were talking about, last time we met, we were talking about what the belief of Candace Kurtz. And whenever they looked for some kind of receptor in the body, in the brain, they found it. So, you know, I mean, it's like, so you could create a new, this is what I have a problem with psychology, where they'll create like new psychological symptoms out of symptoms, right? Right?They created a new thing for the DSM to put in the next edition, right, that they've discovered. And the reality is, it's just experience happening. Things are happening, you know, with these kinds of traits. And then all of a sudden, you, oh, I've got ADHD, or I mean, it's a good way to label it, but you know, it's those things aren't, they don't really, you know, we make things up, it's we make things. And anyway, it just keeps on going on and on and on."
...
> "Yeah, because that's a problem in the world. Everything is an inconvenience. For instance, sound. There's some people that are very intolerant to sound. So I know, okay, I got a little bit of a headache. So sound kind of, especially in the morning, it might kind of like annoy me. You know, I like quiet and build up to my day kind of thing sometimes. But, you know, and it's in other times I can listen to my dovestep and just be turn it up, you know, turn it up to 12, you know. But what I'm just saying is that it's what I want to get across, and this is on this podcast thing, I was, you know, I just come up in my mind. One of the things I want to get to is I want to talk about people about how we take things instead of the external world, you know, is presenting things. So we kind of pres because there's this problem where we always point the finger outside at the external world instead of looking at what we're bringing to the table, what we're, you know, how we're taking this. And, you know, you don't have to go, if somebody says something wrong to you, or kind of, you know, you don't have to go and fight them every time that somebody says something to you. You could turn the other cheek and make life a lot easier for you if you don't, you don't fight, you know. That's their karma, right? You know, you know, I mean, everybody has their part in it. And that's something I wish I could get that across somehow to folks because I think it would help people a lot if they actually took that on as okay, this is a challenge for me to be tolerant, compassionate, have empathy, not take it personal, you know, be resilient, show some resilience to things instead of just being blown around by whatever ill-gotten, you know, you know, anything that might not be ideal."

#### Jin Shin Thyroid Healing Session (9:19 PM – 9:38 PM)
**Journal Entry**  
*Reason: Private reflection focusing on personal stories, spiritual practice, and human behavior with no external audience or commands.*  
> "Says right, place your right hand on top of the very center of your headline, leave it there. That's in the inner traditions. Okay, duration holders 35, why it works. It regulates metabolism, balance, calcium, magnesium levels, and stabilizes blood. The simple daily harmonizer, the third depth finger holds. If you are on the go or prefer some discrete, you can work with the depths of the body. The thyroid is deeply tied into the third depth, which governs the wood element, the liver, the gallbladder organ, and the blood vital circulation. Wrap the fingers of one hand completely around the middle finger on the opposite hand. Wait for a pulse. Tips to be a mindful flow. Be a witness, join as a force. The pulse may feel chaotic or rapid at the contact points initially. As the thyroid energy stabilizes, the pulse becomes calm, synchronized, and steady. Well, holding your middle finger 20 minutes a day for a cycle of 45 days provides the most grounding."

---

## 🧘 Spiritual and Societal Insights
- **Extended mentoring call with sponsee covered**: John Sarno's mind-body pain work, trauma/nervous system regulation books, meditation on clinging vs. pain itself, and the "eight worldly winds" Buddhist teaching
...
* **"Yeah That'S Right"** — 4 occurrences — *Context:* Distinctive conversational expression recorded across today's dialogue.
* **"Telling You About"** — 3 occurrences — *Context:* Distinctive conversational expression recorded across today's dialogue.
...
---
*Report automatically generated on 2026-08-24 06:19:06*
